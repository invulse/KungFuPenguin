...
-(void)setUpCharacter
{
	...
	eskimo.position = ccp(50.0f,0.0f);
	...
	body = [[CCSprite alloc] initWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"Eskimo2Body.png"]];
	leftLeg = [[CCSprite alloc] initWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"Eskimo2Leg.png"]];
	rightLeg = [[CCSprite alloc] initWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"Eskimo2Leg.png"]];
	leftArm = [[CCSprite alloc] initWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"Eskimo2LeftArm.png"]];
	rightArm = [[CCSprite alloc] initWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"Eskimo2RightArm.png"]];
	head = [[CCSprite alloc] initWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"Eskimo2Head.png"]];
...
{
	Animator *animator = [Animator animatorFromFile:@"Eskimo2-Animations.plist"];
	...
	[initFrames addAction:[BEUSetFrame actionWithSpriteFrame:
						   [[CCSpriteFrameCache sharedSpriteFrameCache] 
							spriteFrameByName:@"Eskimo2Head.png"
							]] target:head];
	[initFrames addAction:[BEUSetFrame actionWithSpriteFrame:
						   [[CCSpriteFrameCache sharedSpriteFrameCache] 
							spriteFrameByName:@"Eskimo2LeftArm.png"
							]] target:leftArm];
	[initFrames addAction:[BEUSetFrame actionWithSpriteFrame:
						   [[CCSpriteFrameCache sharedSpriteFrameCache] 
							spriteFrameByName:@"Eskimo2Body.png"
							]] target:body];
	[initFrames addAction:[BEUSetFrame actionWithSpriteFrame:
						   [[CCSpriteFrameCache sharedSpriteFrameCache] 
							spriteFrameByName:@"Eskimo2RightArm.png"
							]] target:rightArm];
	[initFrames addAction:[BEUSetFrame actionWithSpriteFrame:
						   [[CCSpriteFrameCache sharedSpriteFrameCache] 
							spriteFrameByName:@"Eskimo2Leg.png"
							]] target:leftLeg];
	[initFrames addAction:[BEUSetFrame actionWithSpriteFrame:
						   [[CCSpriteFrameCache sharedSpriteFrameCache] 
							spriteFrameByName:@"Eskimo2Leg.png"
	...
	[punch1 addAction:[animator getAnimationByName:@"Punch1-Head"] target:head];
	[punch1 addAction:[animator getAnimationByName:@"Punch1-LeftArm"] target:leftArm];
	[punch1 addAction:[animator getAnimationByName:@"Punch1-Body"] target:body];
	[punch1 addAction:[animator getAnimationByName:@"Punch1-RightArm"] target:rightArm];
	...
	[punch1 addAction:[CCSequence actions:
					   ...
					   [CCCallFunc actionWithTarget:self selector:@selector(punch1Send)],
	...
	[punch2 addAction:[animator getAnimationByName:@"Punch2-Head"] target:head];
	[punch2 addAction:[animator getAnimationByName:@"Punch2-LeftArm"] target:leftArm];
	[punch2 addAction:[animator getAnimationByName:@"Punch2-Body"] target:body];
	[punch2 addAction:[animator getAnimationByName:@"Punch2-RightArm"] target:rightArm];
	...
	[punch2 addAction:[CCSequence actions:
					    ...
					    [BEUSetFrame actionWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"Eskimo2LeftArmPunch.png"]],
	...
	[punch2 addAction:[CCSequence actions:
					 ...
					 [CCCallFunc actionWithTarget:self selector:@selector(punch2Send)],
					 [BEUPlayEffect actionWithSfxName:@"PunchSwing" onlyOne:YES],
					 [CCDelayTime actionWithDuration:0.513f],
	...
	[hit1 addAction:[BEUSetFrame actionWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"Eskimo2HeadHurt.png"]]
			 target:head];
	...
	[hit2 addAction:[BEUSetFrame actionWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"Eskimo2HeadHurt.png"]]
			 target:head];
	...
	[fall1 addAction:
	 [CCSequence actions:
	  [BEUSetFrame actionWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"Eskimo2HeadHurt.png"]],
	  [CCDelayTime actionWithDuration:1.0f],
	  [BEUSetFrame actionWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"Eskimo2Head.png"]],
	  nil
	  ]
			 target:head];
	[fall1 addAction:[CCSequence actions:
					  [CCDelayTime actionWithDuration:1.85f],
					  [CCCallFunc actionWithTarget:self selector:@selector(idle)],
					  nil
					  ]
			  target:self];
	...
	[death1 addAction:[BEUSetFrame actionWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"Eskimo2HeadDead.png"]]
			 target:head];
...
-(void)punch1Send
{
	...
	[[BEUActionsController sharedController] addAction:
	 [[[BEUHitAction alloc] initWithSender:self
								 ...
								 duration:0.05f
								  hitArea:CGRectMake(17, 0, 50, 100)
...
-(void)punch2Send
{
	[[BEUActionsController sharedController] addAction:
	 [[[BEUHitAction alloc] initWithSender:self
								 selector:@selector(receiveHit:)
								 duration:0.05f
								  hitArea:CGRectMake(17, 0, 40, 100)
								   zRange:ccp(-20.0f,20.0f)
								 	power:15
								   xForce:directionMultiplier*100.0f
								   yForce:0.0f

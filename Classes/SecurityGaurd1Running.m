...
@implementation SecurityGaurd1Running
...
-(void)setUpCharacter
{
	...
	leftArm = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"SecurityGaurd1-LeftArm.png"]];
	head = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"SecurityGaurd1-HeadScared.png"]];
	body = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"SecurityGaurd1-Body.png"]];
	leftLeg = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"SecurityGaurd1-LeftLeg.png"]];
	rightLeg = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"SecurityGaurd1-RightLeg.png"]];
	rightArm = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"SecurityGaurd1-RightArm.png"]];
	
	gaurd = [CCNode node];
	gaurd.position = ccp(0,0);
	
	[self addChild:gaurd];
	
	[gaurd addChild:rightArm];
	[gaurd addChild:rightLeg];
	[gaurd addChild:leftLeg];
	[gaurd addChild:body];
	[gaurd addChild:head];
	[gaurd addChild:leftArm];
...
{
	Animator *animator = [Animator animatorFromFile:@"SecurityGaurd1Running-Animations.plist"];
	...
	[death addAction:[BEUSetFrame actionWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"SecurityGaurd1-HeadDead.png"]] target:head];
...
-(void)reset
{
	...
	moveZ = 0;
	moveY = 0;
	[head setDisplayFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"SecurityGaurd1-HeadScared.png"]];

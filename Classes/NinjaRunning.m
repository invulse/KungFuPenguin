...
-(void)setUpCharacter
{
	...
	leftArm = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"NinjaEskimo-LeftArmFist.png"]];
	head = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"NinjaEskimo-HeadScared.png"]];
	body = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"NinjaEskimo-Body.png"]];
	leftLeg = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"NinjaEskimo-LeftLeg.png"]];
	rightLeg = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"NinjaEskimo-RightLeg.png"]];
	rightArm = [CCSprite spriteWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"NinjaEskimo-RightArm.png"]];
	
	ninja = [CCNode node];
	ninja.position = ccp(0,0);
...
{
	Animator *animator = [Animator animatorFromFile:@"NinjaEskimoRunning-Animations.plist"];
	...
	[death addAction:[BEUSetFrame actionWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"NinjaEskimo-HeadDead.png"]] target:head];
...
-(void)reset
{
	...
	moveZ = 0;
	moveY = 0;
	[head setDisplayFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"NinjaEskimo-HeadScared.png"]];

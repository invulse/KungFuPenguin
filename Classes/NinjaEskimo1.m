...
-(void)setUpCharacter
{
	...
	leftArm = [[CCSprite alloc] initWithSpriteFrame:[[CCSpriteFrameCache sharedSpriteFrameCache] spriteFrameByName:@"NinjaEskimo-LeftArmSword.png"]];
...
{
	Animator *animator = [Animator animatorFromFile:@"NinjaEskimo1-Animations.plist"];
	...
	[initFrames addAction:[BEUSetFrame actionWithSpriteFrame:
						   [[CCSpriteFrameCache sharedSpriteFrameCache] 
							spriteFrameByName:@"NinjaEskimo-LeftArmSword.png"
							]] target:leftArm];
	[initFrames addAction:[BEUSetFrame actionWithSpriteFrame:
						   [[CCSpriteFrameCache sharedSpriteFrameCache] 
...
-(void)attack1Send
{
	...
	hit.type = BEUHitTypeCut;
	
	[[BEUAudioController sharedController] playSfx:@"SwordSwing" onlyOne:NO];
